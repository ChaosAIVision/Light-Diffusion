...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        " If not specified vae weights are initialized from vae.",
    )

    parser.add_argument(
        "--is_small_vae",
        action="store_true",
        help="Whether to use a small VAE model.",
    )
    ...
    parser.add_argument(
        ...
        default="sample",
        help=(
            'The scheduler type to use. Choose between ["sample", "v_prediction", "epsilon]'
        ),
    )
    parser.add_argument(
